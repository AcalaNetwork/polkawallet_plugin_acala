const Map<String, String> zhDex = {
  ...
  'earn.dex': '流动性挖矿',
  'earn.loan': 'ACA 挖矿',
  'earn.kar.balance': '我的质押',
  'earn.kar.volume': '总量',
  'earn.kar.pool': '总质押量',
  'earn.kar.rate': '质押量/总量对比',
  'earn.kar.emission': '奖励发放量',
  'earn.kar.loyalty': '忠诚奖励 (累计)',
  'earn.loyalty.forego': '损失忠诚奖励',
  'earn.loyalty.receive': '收到',
  'earn.loyalty.from': '来自忠诚奖励',
  'earn.unbond.title': '解绑中',
  'earn.unbond.total': '解绑中总计',
  'earn.unbond.total.withdraw': '可取回总计',
  'earn.unbond.withdraw': '取回',
  'earn.unbond.restake': '再质押',
  'earn.unbond.queue': '解绑中队列',
  'earn.unbond.ready': '可取回',
  'earn.unbond.max': '解绑中队列过长',
  'earn.add': '添加流动性',
  'earn.remove': '提取流动性',
  ...
  'earn.ldot.warn': 'LDOT 质押奖励领取功能暂不可用, 请晚些再试吧。',
  'homa.title': 'Liquid',
  'homa.mint': '生成',
  'homa.redeem': '提取',
  'homa.fast': '快速取回',
  ...
  'v3.loan.newCollateralRatio': '新质押率',
