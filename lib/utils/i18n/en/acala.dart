const Map<String, String> enDex = {
  ...
  'earn.title': 'Staking',
  'earn.dex': 'LP Staking',
  'earn.loan': 'ACA Staking',
  'earn.kar.balance': 'My Balance',
  'earn.kar.volume': 'Volume',
  'earn.kar.pool': 'Total Staked',
  'earn.kar.rate': 'Total vs Staked Volume',
  'earn.kar.emission': 'Rewards Emission',
  'earn.kar.loyalty': 'Loyalty Bonus (accumulated)',
  'earn.loyalty.forego': 'Forego Loyalty Bonus',
  'earn.loyalty.receive': 'Receive',
  'earn.loyalty.from': 'from Loyalty Bonus',
  'earn.unbond.title': 'Unstaking',
  'earn.unbond.total': 'Total unstaking',
  'earn.unbond.total.withdraw': 'Total ready to withdraw',
  'earn.unbond.withdraw': 'Withdraw',
  'earn.unbond.restake': 'Restake',
  'earn.unbond.queue': 'Unstaking Queue',
  'earn.unbond.ready': 'Ready to Withdraw',
  'earn.unbond.max': 'Unstaking queue too long',
  ...
  'earn.ldot.warn':
      'Reward claim on Collateralized LDOT is temporarily disabled, please try again later.',
  'homa.title': 'Liquid',
  'homa.mint': 'Mint',
  'homa.redeem': 'Redeem',
  ...
  'v3.loan.newCollateralRatio': 'New Collateral Ratio',
